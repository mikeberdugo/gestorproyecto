# Generated by Django 5.0 on 2024-03-04 21:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probavilidad', models.CharField(choices=[('alto2', 'Muy Alto'), ('medio', 'Medio'), ('Bajo2', 'Muy Bajo'), ('alto1', 'Alto'), ('bajo1', 'Bajo')], max_length=20)),
                ('gravedad', models.CharField(choices=[('alto2', 'Muy Alto'), ('medio', 'Medio'), ('Bajo2', 'Muy Bajo'), ('alto1', 'Alto'), ('bajo1', 'Bajo')], max_length=20)),
